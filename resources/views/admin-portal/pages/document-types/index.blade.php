    ...
    <div class="col-12">
       <div class="card">
          ...
          <div class="card-body">
            ...
            {!! Form::model($documentType, ['route' => ['document-types.update',$documentType->id]]) !!}
            @method('PUT')
            @else
                {!! Form::open(['route' => 'document-types.store', 'id' => 'form']) !!}
            @endif
             <div class="row ">
                <div class="col-md-6">
                    <label for="">Name*</label>
                    {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Document Type Name', 'required']) !!}
                </div>
                <div class="col-md-6">
...
<script>
    ...
    $('#table').DataTable({
      ...
      columns: [
        ...
        {data: 'isActive', name: 'isActive', width: '33%' },
